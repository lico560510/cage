...
public class MyGame extends JFrame{
	...
	private class GamePanel extends JPanel{
		...
		public GamePanel() {
			...
			try {
				ball = ImageIO.read(new File("dir1/Ultra_Ball.png"));
		...
		@Override
		protected void paintComponent(Graphics g) { //repaint
